...
Alakli-Metalle bestizen komplett besetzte Schalen und nur ein Valenzelektronen. Diese lassen sich mit Hilfe der Ein-Elektronen-Näherung recht einfach beschreiben. Der Anatz der Näherung beruht darauf, dass die Ladungen der Elektronen, welche die kompletten Schalen besetzen sich mit denen der Protonen des Kerns kompensieren. Somit kann das Atom als Wasserstoffatom genähert werden. Das zwischen dem Proton und Elektron liegende Columbfeld, wird durch die inneren Elektronen abgeschirmt. Dies wird im weiteren Verlauf der Rechnung durch die Abschirmzahl $\sigma$ berücksichtigt.
\begin{equation}
  z_\text{eff} = z - \sigma
  \label{eqn:zeff}
\end{equation}
