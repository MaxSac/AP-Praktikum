...
\begin{equation}
  ...
  \label{eqn:WC}
\end{equation}
soll die Güteziffer des Versuches bestimmt werden. Die Theoretische Güteziffer lässt sich mit hilfe der Gleichung ?? berechnen und ist in Tabelle ?? aufgeführt. Die praktisch bestimmte Güteziffer errechnet sich nach Gleichung ?? aus der Wärmekapazität der Resoirvare und der Aufbaues 
\begin{equation}
  c_k \cdot m_k = \num{750 +- 10} \, \frac{\text{J}}{\text{K}}
  \label{eqn:Res}
\end{equation}
, der Leitung sowie denn in Tabelle 1 bestimmten Differentialquotienten, so wie der gemittelte Leistung
