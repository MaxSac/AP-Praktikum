...
Aus der idealten Gasgleichung lässt sich die Dichte in den Rohren berechnen. Dafür muss jedoch die Dichte zu Bestimmungen bekannt sein. Die dichte von Dichlordifluormethan beträgt bei normal Druck und 273 Kelvin 
\begin{equation}
  \rho_0 =  5.51 \frac{\text{g}}{\text{l}} \ .
  \label{rho}
\end{equation}
...
\begin{equation}
  nR = konstant
\end{equation}
sowie das die Dichte homogen ist. Daraus lässt sich die Ideale Gasgleichung umstellen und man erhält
\begin{eqnarray*}
  \frac{pV}{T} =nR =& konst \\ 
  \frac{p_0 V_0}{T_0} = \frac{p_2 V_2}{T_2}  \Leftrightarrow&  \frac{p_0 m}{\rho_0 T_0} = \frac{p_2 m}{T_2 \rho_2} \\
  \frac{p_0}{\rho_0 T_0} = \frac{p_2}{T_2 \rho} \Leftrightarrow& \rho = \frac{\rho_o T_o P_2}{T_2 P_0}
  \label{eqn:rho}
\end{eqnarray*}
