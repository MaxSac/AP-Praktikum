...
plt.plot(U[0:2], A[0:2]/10, 'bx')
plt.plot(U[13:16], A[13:16]/10, 'bx')
plt.plot(xWert, Fit(xWert, **result.params), 'r-', label='gefittete Messwerte')
plt.plot((350, 350), (450, 700), 'g-')
plt.plot((650, 650), (450, 700), 'g-')
plt.xlabel('$U$ / V')
...
print(T)
print('---------------------------------------------------------------------')
print('N1  =', ufloat(425, math.sqrt(4250)/10))
print('N2  =', ufloat(336, math.sqrt(3363)/10))
print('N12 =', ufloat(704, math.sqrt(7035)/10))
N1  = ufloat(425, math.sqrt(4250)/10)
N2  = ufloat(336, math.sqrt(3363)/10)
N12 = ufloat(704, math.sqrt(7035)/10)
T = (N1+N2-N12) / (2*N1*N2)
print(T)
print('---------------------------------------------------------------------')
print('---------------------------------------------------------------------')
