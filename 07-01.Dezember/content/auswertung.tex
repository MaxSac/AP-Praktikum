...
Für die verschiedenen Phasen ergibt es durch die Multiplikation der Rechteckspannung mit der Sinusspannung verschieden Graphen welche nach Formel \ref{eqn:foye} mittels einer Fourierentwicklung berrechnen lässt. Die zu den verschiedenen Phasen entsprechenden Graphen sind in Abblidung \ref{fig:graph1} und \ref{fig:graph2} zu sehen.
...
\begin{figure}
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{$\phi = 120$}
  \end{subfigure}
  \caption{Fourierreihe für 60 und 120 grad Phasendifferenz}
  \label{fig:graph1}
\end{figure}
\begin{figure}
  \centering
  ...
  \begin{subfigure}{0.48\textwidth}
    ...
    \caption{$\phi = 240$}
  \end{subfigure}
  \caption{Fourierreihe für 180 und 240 grad Phasendifferenz}
  \label{fig:graph2}
\end{figure}
...
\begin{figure}
  ...
  \caption{Abstandsspannungsrelation} 
  \label{fig:rU}
\end{figure}
