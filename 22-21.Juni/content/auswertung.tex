...
\begin{table}
  ...
  \label{tab:ABlei}
\end{table}
In Diagramm \ref{fig:Blei} wird die Massenbelegung auf der x-Achse gegen die Zählrate auf der logarithmierten y-Achse aufgetragen. Anhand eines Fittes der Form
\begin{equation}
